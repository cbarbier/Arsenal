...
//	console.log("HELLLLLLLLLLLLLLLLLLOOOOOOOOOOOOO" + reqMethod);
...
function checkBucketAndKey(bucketName, objectKey, method, reqQuery,
    blacklistedPrefixes, log, param) {
	console.log("tiiiiiiiiiiiiiototototot\n" + method + " " + JSON.stringify(objectKey));
...
function routes(req, res, params, logger) {
    ...
    const bucketOrKeyError = checkBucketAndKey(req.bucketName, req.objectKey,
        req.method, req.query, blacklistedPrefixes, log, params);
