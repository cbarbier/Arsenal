...
function checkUnsupportedRoutes(reqMethod, param) {
	console.log("HELLLLLLLLLLLLLLLLLLOOOOOOOOOOOOO" + reqMethod + param);
...
function routes(req, res, params, logger) {
	...
	console.log(params.api + " ttttttttttttttttttttttttttttttttttttttttt1\n");
    const { error, method } = checkUnsupportedRoutes(req.method, params req.query);
	console.log(params + " ttttttttttttttttttttttttttttttttttttttttt2\n");
	...
	console.log("asgdhfgjmnbfdsfg" + req);
